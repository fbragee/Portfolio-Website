<footer class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b> federicobragee@gmail.com</p>    
        <p><b class="pr-2">Github</b> 
            <a href="https://github.com/fbragee" class="text-violet-400" target="_blank">fbragee <sup><span class="text-xs scale-75 pl-0.5">
                <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"></i>
            </span></sup></a>
        </p>
        <p><b class="pr-2">LinkedIn</b> 
            <a href="https://instagram.com/federicobragee" class="text-violet-400" target="_blank">federicobragee <sup><span class="text-xs scale-75 pl-0.5">
                <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"></i>
            </span></sup></a>
        </p>        
    </div>
